...
```
cd existing_repo
git remote add origin https://gitlab.com/mind2matter/my-reliable-site-frontend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mind2matter/my-reliable-site-frontend/-/settings/integrations)
